...
/**
 * Сервис для генерации HTML резюме
 * Поддерживает две темы: профессиональную и креативную
 */
public class HtmlGenerator {
    
    /**
     * Генерирует HTML код резюме в зависимости от выбранной темы
     * @param data данные резюме
     * @return HTML код
     */
    ...
    /**
     * Генерирует профессиональную тему резюме
     * @param data данные резюме
     * @return HTML код с профессиональным дизайном
     */
    ...
    /**
     * Генерирует креативную тему резюме
     * @param data данные резюме
     * @return HTML код с креативным дизайном
     */
